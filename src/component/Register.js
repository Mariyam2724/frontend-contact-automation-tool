              ...
              <div class="card-body">
                <b>
                  <h2 className="form-title" style={{ textAlign: "center" }}>
                    Create an account
                    <img src="https://cdn.iconscout.com/icon/premium/png-128-thumb/add-user-2606382-2183808.png" class="logo" />
                  </h2>
                </b>
                ...
                <Formik initialValues={{ fullname: "", email: "", password: "" }} onSubmit={userSubmit}>
                  {({ values, handleChange, handleSubmit }) => (
                    <form onSubmit={handleSubmit}>
                      ...
                      <button type="submit" className="btn btn-lg btn-success mt-5">
                        REGISTER
                      </button>
